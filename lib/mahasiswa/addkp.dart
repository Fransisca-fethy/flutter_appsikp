...
//AddSurat({Key key}) : super(key: key);
  ...
  @override
  _AddKPState createState() => _AddKPState();
}
...
class _AddKPState extends State<AddKP> {
  ...
  final TextEditingController judulkpController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference kp = firestore.collection('kp');
                  ...
                  ElevatedButton(
                    ...
                    //Navigator.pop(context);
                      kp.add({
                        ...
                        'judulkp' : judulkpController.text,
